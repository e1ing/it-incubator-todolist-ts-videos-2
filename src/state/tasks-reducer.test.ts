...
const startState: TasksStateType = {
    "todolistId1": [
        {: "1", title: "CSS", status: TaskStatuses.New, todoListId: "todolistId1",
        startDate:'', deadline: '', addedDate: '', order:0, priority: TaskPriorities.High},
    ...
    "todolistId2": [
        ...
        {id: "2", title: "milk",status: TaskStatuses.New, todoListId: "todolistId2",
            startDate:'', deadline: '', addedDate: '', order:0, priority: TaskPriorities.High},
        {id: "3", title: "tea", status: TaskStatuses.Completed, todoListId: "todolistId2",
            startDate:'', deadline: '', addedDate: '', order:0, priority: TaskPriorities.High}
    ]
};
...
test('status task should be changed to correct array', () => {
    const startState: TasksStateType = {
        "todolistId1": [
...
test('tasks should be added for  todolis ts', () => {
